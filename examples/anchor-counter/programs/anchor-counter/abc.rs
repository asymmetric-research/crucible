...
pub static ID: anchor_lang::solana_program::pubkey::Pubkey = anchor_lang::solana_program::pubkey::Pubkey::new_from_array([
    169u8, 86u8, 156u8, 6u8, 178u8, 48u8, 28u8, 103u8, 189u8, 205u8, 235u8, 109u8, 136u8,
    181u8, 5u8, 13u8, 91u8, 3u8, 97u8, 240u8, 6u8, 209u8, 231u8, 32u8, 66u8, 166u8,
    178u8, 26u8, 90u8, 44u8, 68u8, 132u8,
]);
/// Const version of `ID`
...
fn dispatch<'info>(
    ...
    if data.starts_with(instruction::Decrement::DISCRIMINATOR) {
        return __private::__global::decrement(
            program_id,
            accounts,
            &data[instruction::Decrement::DISCRIMINATOR.len()..],
        );
    }
...
mod __private {
                        ...
                        anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                                ...
                                error_origin: Some(
                                    anchor_lang::error::ErrorOrigin::Source(anchor_lang::error::Source {
                                        filename: "programs/anchor-counter/src/lib.rs",
                                        line: 5u32,
                                    }),
                                ),
    ...
    pub mod __global {
        ...
        pub fn increment<'info>(
            ...
            let mut __bumps = <Update as anchor_lang::Bumps>::Bumps::default();
            let mut __reallocs = std::collections::BTreeSet::new();
            let mut __remaining_accounts: &[AccountInfo] = __accounts;
            let mut __accounts = Update::try_accounts(
                __program_id,
                &mut __remaining_accounts,
                __ix_data,
                &mut __bumps,
        ...
        #[inline(never)]
        pub fn decrement<'info>(
            __program_id: &Pubkey,
            __accounts: &'info [AccountInfo<'info>],
            __ix_data: &[u8],
        ) -> anchor_lang::Result<()> {
            ::solana_msg::sol_log("Instruction: Decrement");
            let ix = instruction::Decrement::deserialize(&mut &__ix_data[..])
                .map_err(|_| {
                    anchor_lang::error::ErrorCode::InstructionDidNotDeserialize
                })?;
            let instruction::Decrement = ix;
            let mut __bumps = <Update as anchor_lang::Bumps>::Bumps::default();
            let mut __reallocs = std::collections::BTreeSet::new();
            let mut __remaining_accounts: &[AccountInfo] = __accounts;
            let mut __accounts = Update::try_accounts(
...
pub mod instruction {
    ...
    impl borsh::ser::BorshSerialize for Decrement {
        fn serialize<W: borsh::maybestd::io::Write>(
            &self,
            writer: &mut W,
        ) -> ::core::result::Result<(), borsh::maybestd::io::Error> {
    ...
    impl borsh::de::BorshDeserialize for Decrement {
        fn deserialize_reader<R: borsh::maybestd::io::Read>(
            reader: &mut R,
        ) -> ::core::result::Result<Self, borsh::maybestd::io::Error> {
            Ok(Self {})
    ...
    impl anchor_lang::Discriminator for Decrement {
        const DISCRIMINATOR: &'static [u8] = &[106, 227, 168, 59, 248, 27, 150, 101];
    }
    impl anchor_lang::InstructionData for Decrement {}
    impl anchor_lang::Owner for Decrement {
        fn owner() -> Pubkey {
            ID
        }
    }
...
pub mod accounts {
    ...
    pub use crate::__client_accounts_update::*;
}
        ...
        *__accounts = &__accounts[1..];
        ...
        let counter = ({
            ...
            || {
                ...
                let space = 8 + Counter::INIT_SPACE;
                    ...
                    || actual_owner == &anchor_lang::solana_program::system_program::ID
                {
                        ...
                        if payer.key() == counter.key() {
                            return Err(
                                anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                                    ...
                                    .with_pubkeys((payer.key(), counter.key())),
                            );
                        }
                    ...
                    match anchor_lang::accounts::account::Account::try_from(&counter) {
                        Ok(val) => val,
                        Err(e) => return Err(e.with_account_name("counter")),
                    }
                };
...
pub(crate) mod __cpi_client_accounts_initialize {
    ...
    impl<'info> anchor_lang::ToAccountInfos<'info> for Initialize<'info> {
        fn to_account_infos(
            ...
            let mut account_infos = ::alloc::vec::Vec::new();
            account_infos
                .extend(anchor_lang::ToAccountInfos::to_account_infos(&self.counter));
            account_infos
...
#[automatically_derived]
impl<'info> anchor_lang::Accounts<'info, UpdateBumps> for Update<'info>
where
    'info: 'info,
{
    #[inline(never)]
...
#[automatically_derived]
impl<'info> anchor_lang::AccountsExit<'info> for Update<'info>
where
    'info: 'info,
{
    fn exit(
...
#[automatically_derived]
impl ::core::fmt::Debug for UpdateBumps {
    #[inline]
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ::core::fmt::Formatter::write_str(f, "UpdateBumps")
    }
}
impl Default for UpdateBumps {
    fn default() -> Self {
        UpdateBumps {}
    }
}
impl<'info> anchor_lang::Bumps for Update<'info>
where
    'info: 'info,
{
    type Bumps = UpdateBumps;
}
/// An internal, Anchor generated module. This is used (as an
/// implementation detail), to generate a struct for a given
/// `#[derive(Accounts)]` implementation, where each field is a Pubkey,
...
pub(crate) mod __client_accounts_update {
    use super::*;
    use anchor_lang::prelude::borsh;
    /// Generated client accounts for [`Update`].
    pub struct Update {
        pub counter: Pubkey,
    }
...
pub(crate) mod __cpi_client_accounts_update {
    use super::*;
    /// Generated CPI struct of the accounts for [`Update`].
    pub struct Update<'info> {
        pub counter: anchor_lang::solana_program::account_info::AccountInfo<'info>,
    }
    #[automatically_derived]
    ...
    u64: borsh::BorshDeserialize,
{
    fn deserialize_reader<R: borsh::maybestd::io::Read>(
        ...
        Ok(Self {
            count: borsh::BorshDeserialize::deserialize_reader(reader)?,
        })
    }
}
#[automatically_derived]
